...
function kshioshita_setup() {
	...
	add_theme_support( 'custom-background', apply_filters( 'kshioshita_custom_background_args', array(
 ...
 */
function kshioshita_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'kshioshita_content_width', 640 );
}
 ...
 */
function kshioshita_widgets_init() {
...
add_action( 'wp_enqueue_scripts', 'kshioshita_scripts' );
