...
function kshioshita_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'theme_bg_color', 
				array(
					'label'		=> __( 'Header and footer background color', 'kshioshita'),
					'section'	=> 'colors',
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'interactive_color', array(
				'label'		=> __( 'Interactive color (links etc)', 'kshioshita' ),
				'section'	=> 'colors',
	...
	$wp_customize->add_section( 'theme_options', 
		array(
			'title'			=> __( 'Theme Options', 'kshioshita' ),
			'priority'		=> 95,
			'capability'	=> 'edit_theme_options',
			'description'	=> __( 'Change how much of a post is displayed on index and archive pages.', 'kshioshita' )
		)
	);
	...
	$wp_customize->add_setting(	'length_setting',
		array(
			'default'			=> 'excerpt',
			'type'				=> 'theme_mod',
			'sanitize_callback' => 'kshioshita_sanitize_length', // Sanitization function appears further down
			'transport'			=> 'postMessage'
		)
	);

	// Add the controls
	$wp_customize->add_control(	'kshioshita_length_control',
		array(
			'type'		=> 'radio',
			'label'		=> __( 'Index/archive displays', 'kshioshita' ),
			'section'	=> 'theme_options',
			'choices'	=> array(
				'excerpt'		=> __( 'Excerpt (default)', 'kshioshita' ),
				'full-content'	=> __( 'Full content', 'kshioshita' )
			),
...
function kshioshita_sanitize_length( $value ) {
...
if ( ! function_exists( 'kshioshita_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog.
 *
 * @see kshioshita_custom_header_setup().
 */
function kshioshita_header_style() {
